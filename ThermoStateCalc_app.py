...
class main_window(QWidget,Ui__frm_StateCalculator):
    ...
    def setUnits(self, specified_properties_layout=None):
        """
        ...
        if 'Pressure' in SpecifiedProperty2:
            ...
            # Create group box containers for State 1 and State 2
            self.state1_groupbox = QGroupBox("State 1")
            self.state2_groupbox = QGroupBox("State 2")

            # Create combo boxes for Property 1 and Property 2 for each state
            self.cmb_State1_Property1 = QComboBox()
            self.cmb_State1_Property2 = QComboBox()
            self.cmb_State2_Property1 = QComboBox()
            self.cmb_State2_Property2 = QComboBox()

            # Layout for State 1 group box
            state1_layout = QVBoxLayout()
            state1_layout.addWidget(self.cmb_State1_Property1)
            state1_layout.addWidget(self.cmb_State1_Property2)
            self.state1_groupbox.setLayout(state1_layout)

            # Layout for State 2 group box
            state2_layout = QVBoxLayout()
            state2_layout.addWidget(self.cmb_State2_Property1)
            state2_layout.addWidget(self.cmb_State2_Property2)
            self.state2_groupbox.setLayout(state2_layout)

            # Add State 1 and State 2 group boxes to the Specified Properties group box
            specified_properties_layout.addWidget(self.state1_groupbox)
            specified_properties_layout.addWidget(self.state2_groupbox)
